...
board = [" "] * 9 
current_player = "X"  # initiated the current player with X
# " " = empty box
# * 9 = repeat 9 times
...
def check_winner(player):
    ...
    for pos in win_position:
        # If all 3 positions have the same player's symbol → win
...
def check_draw():
    # If no empty space (" ") is left → it's a draw
    return " " not in board
...
# Mian game loop -> loop to call the function and move ahead in our game
while True: 
